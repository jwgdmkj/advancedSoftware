...
int MatchAndDraw(struct feature* feat1, struct feature* feat2, int n1, int n2, 
	IplImage* stacked, int width)
{
	...
	for (i = 0; i < n1; i++) {
		...
		// PROBLEM 2 : Calculate the similarity between the decriptors of the 
		//image SIFT feature.
		...
		//f1과 f2포인트들을 각각 반올림하고, 선을 긋는다
		//즉 실제로 위에서 값을 넣어야 되는 포인트들은 f1과 f2
